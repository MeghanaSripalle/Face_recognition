                    ...
                    <div class="row" style="align-items:center;justify-content:center;">
                        <div class="col-lg-4 col-md-6 mt-5">
                            <div class="card card-bordered">
                                <img class="card-img-top img-fluid" src="labeled_images/<?php echo $name;?>/1.jpg" alt="image">
                                <div class="card-body">
                                    <div class="title col-12" style="font-family: 'Times New Roman', Times, serif;background-color:#cc902a">Name:
                                    <?php echo $name; ?></div>
                                    <div class="title col-12" style="font-family: 'Times New Roman', Times, serif;background-color:#f29891">Class: 
                                    <?php echo $class; ?></div>
                                    <div class="title col-12" style="font-family: 'Times New Roman', Times, serif;background-color:#e6da85">Phone Number: 
                                    <?php echo $phoneno; ?></div>
                                    <div class="title col-12" style="font-family: 'Times New Roman', Times, serif;background-color:#9ce6dc">Email Address: 
                                    <?php echo $emailaddress; ?></div>
